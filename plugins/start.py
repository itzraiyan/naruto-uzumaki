...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        #k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️𝗜𝗠𝗣𝗢𝗥𝗧𝗔𝗡𝗧❗️</b>\n\n<b>These Files Will Be Deleted In {file_auto_delete} (Due To Copyright Issues).</b>\n\n<b>📌 Please Forward The Files To Somewhere Else And Start Downloading There.</b>")
...
async def delete_files(messages, client, k):
    ...
    await k.edit_text("<b>The posts were auto-removed by our bot to avoid copyright issues. You can still access them via the main link, but they'll be removed again in 3 days⏳</b>")
