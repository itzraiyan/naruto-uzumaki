...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://ichigo:ichigo@cluster0.kal7f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
try:
    ADMINS=[6848088376]
    for x in (os.environ.get("ADMINS", "7278618573 2061656269 7492130028").split()):
        ADMINS.append(int(x))
except ValueError:
